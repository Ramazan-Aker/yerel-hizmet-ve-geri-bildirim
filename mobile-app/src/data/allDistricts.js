...
export const allDistricts = {
  ...
  'Ankara': [
    'Altındağ', 'Çankaya', 'Etimesgut', 'Keçiören', 'Mamak', 'Pursaklar', 'Sincan',
    'Yenimahalle', 'Akyurt', 'Ayaş', 'Bala', 'Beypazarı', 'Çamlıdere', 'Çubuk', 'Elmadağ',
    'Evren', 'Gölbaşı', 'Güdül', 'Haymana', 'Kalecik', 'Kazan', 'Kızılcahamam',
    'Nallıhan', 'Polatlı', 'Şereflikoçhisar'
  ],
  'İzmir': [
...
// Diğer şehirler için şehir seçildiğinde otomatik olarak Merkez ilçesini ekleyen fonksiyon
